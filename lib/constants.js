...
sIDRegion =			11;   //Continent has been identified, ready for country ID by user
sTestRegion  =		12;   //Country selected by user
sRegionOK =			13;  //User chose correct country
sRegionBad =		14;	 //User chose wrong country
sRegionFeatured =	15;	//"intercepted data" revealed the region

sIDCountry =		16;   //Continent has been identified, ready for country ID by user
sTestCountry =		17;   //Country selected by user
