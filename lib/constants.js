...
//****************************************************************
Slingshot.fileRestrictions("ghC", {
...
Slingshot.fileRestrictions("ghStoryPic", {
  allowedFileTypes: ["image/png", "image/jpeg", "image/jpg", "image/gif", "audio/mp3"],
  maxSize: 10 * 1024 * 1024 // 10 MB (use null for unlimited).
});
...
makeSingleElementArray = function( _arr, _field) {
...
arrUserStatus = ["(none)", "Active", "Virtual", "Honorary", "Inactive", "Deleted", "Admin", "Test", "Fake"];
